<div align="center">
  <img src="Icon/aim4lab_app_icon.png" alt="AIM4LAB LocalCustomGUI" width="96">
  <h1>형상/시험 변수 기반<br>고압차단기 성능 예측</h1>
  <p><strong>AIM4LAB LocalCustomGUI for Windows</strong></p>
  <p>Excel 업로드부터 모델 학습, 성능 비교, 예측 리포트까지 로컬 PC에서 한 화면으로 처리합니다.</p>
  <p>
    <a href="#1-exe-실행-및-설치"><strong>EXE 설치</strong></a>
    ·
...
<p align="center">
  <img src="docs/assets/screenshots/streamlit-home.png" alt="Streamlit start screen" width="900">
</p>
...
| 입력 예시 | 상세 사용법 |
| --- | --- |
| `방금 올린 엑셀 요약해줘` | [Excel 요약](docs/user_guide/excel-summary.md) |
| `분류 모델 학습해줘` | [분류 모델 학습](docs/user_guide/classification-training.md) |
| `저장된 분류 모델로 예측해줘` | [저장 모델 예측](docs/user_guide/saved-classification-prediction.md) |
| `모델 성능 비교표를 설명해줘` | [성능 비교 설명](docs/user_guide/performance-comparison.md) |
| `예측 결과 리포트 만들어줘` | [리포트 생성 및 예시 산출물](docs/user_guide/report-generation.md) |
...
- [기능별 자연어 사용 가이드](docs/user_guide/README.md)
